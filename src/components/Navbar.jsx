    ...
    <nav className="bg-black">
      <div className=" text-gray-50 align-element py-4 flex flex-row justify-between items-center sm:flex-row sm:gap-x-16 sm:items-center sm:py-8">
        <h2 className="text-3xl font-bold">
          Web<span className="text-sky-300">Dev</span>
        </h2>
        <div className="hidden md:flex md:gap-x-3 md:items-center">
          ...
          <a
            href="#contact"
            className="bg-sky-300 shadow-sm shadow-sky-300 rounded-lg text-black text-xl text-center px-3 mx-3 font-bold uppercase  hover:bg-sky-50   duration-300"
          >
            Kontakt
          </a>
        </div>
      ...
      {menuOpen && (
        <div className="align-element flex flex-col pb-2 gap-y-1 items-center md:hidden">
          ...
          <a
            href="#contact"
            className="bg-sky-300 shadow-lg shadow-sky-300 rounded-lg text-gray-800 text-xl text-center px-3 my-3 font-bold uppercase  hover:bg-sky-400 hover:shadow-lg border border-sky-400 duration-300"
          >
            Kontakt
          </a>
        </div>
